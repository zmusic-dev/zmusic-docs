  ...
  return [
    ...
    { text: 'Discord Rules', link: '/en/group' },
    {
      ...
      items: [
        ...
        { text: 'Changelog', link: 'https://github.com/starhui-dev/zmusic-plugin/blob/archive/v4/CHANGELOG.md' }
      ]
    }
  ]
}
